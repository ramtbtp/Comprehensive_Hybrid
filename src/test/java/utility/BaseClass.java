...
public class BaseClass {
	...
	public void required() {
		System.setProperty("extent.reporter.avent.config","E:\\msa\\Comprehensive Hybrid\\configs\\extentReports-config.properties");
		log.createLogger(getClass());
	
		webDriver = new WebDriverHelper();
	
		if (ConfigReader.getBrowser().contains("chrome")) {
			System.setProperty("webdriver.chrome.driver","E:\\msa\\Comprehensive Hybrid\\drivers\\chromedriver.exe");
			driver = new ChromeDriver();
			log.info("Driver set as Chrome");
		} else if (ConfigReader.getBrowser().contains("firefox")) {
			System.setProperty("webdriver.gecko.driver","E:\\msa\\Comprehensive Hybrid\\drivers\\geckodriver.exe");
	...
	public void extendReportSetup() {
		System.setProperty("log4j2.configurationFile","C:\\Users\\Atawul Vadud\\eclipse-workspace\\Comprehensive Hybrid\\configs\\log4j2-config.xml");
		log = new Log();
